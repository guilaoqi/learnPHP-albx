<?php 
  // require_once('/home/albx/'.'config.php');
...
?> 
  ...
  <div class="aside">
    <div class="profile">
      <img class="avatar" src="<?php echo empty($avatar)?'/static/assets/img/default.png':$avatar ;?>">
    ...
    <ul class="nav">
      ...
      <?php $menu_posts=['posts','post_add','categories'] ?>
      <li <?php echo in_array($current_page, $menu_posts)?'class="active"':''  ?> >
        ...
        <ul id="menu-posts" class="collapse <?php echo in_array($current_page, $menu_posts)?' in':''  ?> " >
          ...
          <li <?php echo $current_page==="post_add"?'class="active"':'' ?> ><a href="post-add.php">写文章</a></li>
      ...
      <?php $menu_settings=['nav_menus','slides','settings'] ?>
      <li <?php echo in_array($current_page, $menu_settings)?'class="active"':''  ?> >
        ...
        <ul id="menu-settings" class="collapse <?php echo in_array($current_page, $menu_settings)?' in':''  ?> ">
          <li <?php echo $current_page==="nav_menus"?'class="active"':'' ?> ><a href="nav-menus.php">导航菜单</a></li>
